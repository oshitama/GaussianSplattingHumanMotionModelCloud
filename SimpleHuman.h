...
// 順運動学計算
void  ForwardKinematics( const Posture & posture, std::vector< Matrix4f > & seg_frame_array, std::vector< Point3f > & joi_pos_array );

// 順運動学計算
void  ForwardKinematics( const Posture & posture, std::vector< Matrix4f > & seg_frame_array );
